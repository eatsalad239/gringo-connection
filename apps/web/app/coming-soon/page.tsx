...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: isEs ? 'Próximamente — Gringo Connection' : 'Coming Soon — Gringo Connection',
    description: isEs
      ? 'Soluciones de automatización e IA de próxima generación para Colombia. Próximamente.'
      : 'Next-generation automation and AI solutions for Colombia. Coming soon.',
  };
}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
            {isEs ? (
              ...
              <>
                ...
                <br />
                <span className="text-primary-600">Business Automation</span>
              </>
            )}
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            {isEs
              ...
              : "We're building something powerful. Enterprise-grade AI solutions designed specifically for the Colombian market—with deep integration into Medellín's ecosystem and beyond."}
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              {isEs ? 'Obtener Acceso Anticipado' : 'Get Early Access'}
            </Link>
            <Link
              href={prefix || '/'}
            ...
            return (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">
                  {isEs ? feature.title_es : feature.title_en}
                </h3>
                <p className="text-gray-600 leading-relaxed">
                  {isEs ? feature.description_es : feature.description_en}
                </p>
              </div>
            );
          })}
        ...
        <div className="bg-gradient-to-r from-primary-600 to-primary-700 rounded-2xl p-8 md:p-12 text-white text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            {isEs ? 'Hecho en Medellín, Para Colombia' : 'Built in Medellín, For Colombia'}
          </h2>
          <p className="text-xl text-primary-100 mb-6 max-w-2xl mx-auto">
            {isEs
              ...
              : "Partnered with Gato Blanco in Zona Rosa, we're creating solutions that understand Colombian business culture, regulations, and opportunities."}
          </p>
          <Link
          ...
          >
            {isEs ? 'Conoce Nuestra Asociación' : 'Learn About Our Partnership'}
          </Link>
        </div>
        ...
        <div className="mt-16 text-center">
          <p className="text-gray-500 text-sm mb-4">
            {isEs ? '¿Quieres ser notificado cuando lancemos?' : 'Want to be notified when we launch?'}
          </p>
          <Link
            href={`${prefix}/contact`}
